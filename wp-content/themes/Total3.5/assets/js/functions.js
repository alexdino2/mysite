...
( function( $ ) {
    ...
    wpex = {
        ...
        customHovers: function() {
            ...
            $( '.wpex-hover-data' ).remove(); // prevent dups

            $( '.wpex-data-hover' ).each( function( index, value ) {

                var $this       = $( this );
                var hoverCSS    = '';
                var hoverBg     = $this.attr( 'data-hover-background' );
                var hoverColor  = $this.attr( 'data-hover-color' );
                var uniqueClass = 'wpex-data-hover-' + index;
            ...
            if ( headCSS ) {
                headCSS = '<style class="wpex-hover-data">/** CUSTOM HOVERS **/' + headCSS + '</style>';
                $( 'head' ).append( headCSS );
            }
