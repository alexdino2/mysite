			...
			<div id="content" class="site-content" role="main">
				...
				while ( have_posts() ) : the_post(); ?>
					...
					<div class="entry-content entry clr">
						<?php the_content(); ?>
                                                    <?php
                                                        //if query variable is set then use it
                                                        global $wp_query;
                                                        if (isset($wp_query->query_vars['myvar']))
                                                        {
                                                        $var=$wp_query->query_vars['myvar'];
                                                        }                                                        
                                                        ...
                                                        $sql="select dim2, max(c_rate) as max,
                                                                SUBSTRING_INDEX(
                                                                    SUBSTRING_INDEX(
                                                        ...
                                                        FROM    (select whichdim2, dim2, den, num, num/den as c_rate from tbl_dim1_dim2_den_num where dim2='".$var."') AS f
                                                        GROUP BY dim2
                                                        union
                                                        SELECT  'Others',
                                                                max(c_rate) as max,
                                                                ...
                                                                sum(den) as visits,
                                                                sum(num) as conversions
                                                        FROM    (select whichdim2, dim2, den, num, num/den as c_rate from tbl_dim1_dim2_den_num where dim2<>'".$var."') AS f2";
