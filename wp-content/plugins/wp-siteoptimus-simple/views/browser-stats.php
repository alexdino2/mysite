...
<div class="data_boxes">
  <div class="data_boxes_title"><?php echo _e('BROWSERS STATS', 'wp-siteoptimus');?><div class="arrow_btn"></div></div>
  ...
  <div class="data_boxes_footer">
      ...
      <span class="information-txt"><?php echo _e('listing statistics of top five browsers.', 'wp-siteoptimus');?></span>
  </div>
</div>
<?php } ?>