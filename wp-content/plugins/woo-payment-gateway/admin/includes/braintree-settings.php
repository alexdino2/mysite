...
return array(
		'apisettings_title'=>array(
				...
				'description'=>__('In order to start accepting payments using your Braintree account, you will need
						...
						<a href="https://www.braintreegateway.com/login">Production</a> & <a href="https://sandbox.braintreegateway.com/login">Sandbox account</a>.
						Once logged in, navigate to <span>Acount</span> > <span>My User</span>, and scroll to the bottom of the page
						and click the <span>View Authorizations</span> link.', 'braintree')
		),
		...
		'subscriptions_title'=>array(
				...
				'description'=>__('There are two configurable subscription modes with this plugin. You must have WooCoomerce subscriptions enabled in order to accept subscription payments. 
						...
						payment to be charged, the WooCommerce subscription plugin will use the payment token to run the transaction. This options is best suited for merchants that have complex subscription options such as daily, weekly, or bi-weekly subscription plans.</div>', 'braintree')
		),
		...
		'webhooks_title'=>array(
				...
				'description'=>__('If you have enabled Braintree Webhooks, then your site will be configured to receive messages from Braintree pertaining to subscriptions. For example,
						if webooks are enabled and a customer\'s subscription payment fails, Braintree will send a message to your site indicating the subscription that failed. The plugin will then perform 
						...
						In order for webhooks to work, you must add a webhook url within your braintree account. Login to your <a target="_blank" href="https://braintreepayments.com/login">Braintree Account</a> and navigate to 
		...
		'production_environment'=>array(
				...
				'description'=>__('This setting will enable the prodution mode. You must purchase a license and
						...
						<a target="_blank" href="https://wordpress.paymentplugins.com/product-category/braintree-plugins/">Payment Plugins</a>.', 'worldpayus')
		),
		'sandbox_environment'=>array(
				...
				'description'=>__('This setting will enable sandbox mode. In sandbox mode you can test your integration. If enabled, your sandbox
						API keys will be used to communicate with the <a href="https://sandbox.braintreegateway.com">Braintree Samdbox Environment</a>.', 'worldpayus')
		),
		'production_merchant_id'=>array(
				...
				'description'=>__('Your Merchant ID is used to identify you within Braintree\'s environment. You can find your merchant Id by logging 
						into the <a target="_blank" href="https://sandbox.braintreepayments.com/login">Sandbox Environment</a> and navigating to <span>Acount</span> > <span>My User</span>
		...
		'order_status'=>array(
				...
				'value'=>array('completed', 'processing', 'pending', 'on-hold'),
				'default'=>'',
				'class'=>array(),
				'tool_tip'=>true,
		...
		'order_prefix'=>array(
				...
				'class'=>array(),
				'tool_tip'=>true,
				'description'=>__('The order prefix is appened to the order id and used by Braintree. This settings can be helpful if you want to distinguish
		...
		'braintree_subscriptions_charge_failed'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the WooCommerce Subscription object when the subscription charge is unsuccesful. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_subscriptions_charge_success'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the WooCommerce Subscription object when the subscription charge is successful. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_subscriptions_active'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the WooCommerce Subscription object when the subscription has gone active. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_subscriptions_expired'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the WooCommerce Subscription object when the subscription has expired. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_subscriptions_past_due'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the WooCommerce Subscription object when the subscription has gone past due. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_subscriptions_cancelled'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the WooCommerce Subscription object when the subscription has been cancelled. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		...
		'donation_currency'=>array(
				...
				'class'=>array(''),
				'tool_tip'=>true,
				'description'=>__('You can set the currency that will display on the amount field. Ensure this currencyy matches the currency for your Braintree Account.', 'braintree')
		),
		...
		'woocommerce_braintree_merchant_acccounts'=>array(
				...
				'class'=>array(''),
				'tool_tip'=>true,
				'description'=>__('Add additional Merchant Account ID\' if you don\'t want to use your default Merchant Account ID.', 'braintree')
		...
		'braintree_only_subscriptions_charge_failed'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to theSubscription object when the subscription charge is unsuccesful. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_only_subscriptions_charge_success'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the Subscription object when the subscription charge is successful. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_only_subscriptions_active'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the Subscription object when the subscription has gone active. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_only_subscriptions_expired'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the Subscription object when the subscription has expired. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_only_subscriptions_past_due'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the Subscription object when the subscription has gone past due. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
		),
		'braintree_only_subscriptions_cancelled'=>array(
				...
				'class'=>array('subItem'),
				'tool_tip'=>true,
				'description'=>__('If you have enabled webooks, this is the status assigned to the Subscription object when the subscription has been cancelled. You must
						enable webhooks from within the Braintree Admin Panel. Instructions can be found on <a href="https://braintreepayments.com">Braintree</a> on how to setup a webhook.', 'braintree')
