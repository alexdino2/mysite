...
class Custom_Google_Analytics_Front {
	...
	if ( $page_id == $cgaDashSetting['setting']['goalCycleMetaPage'] ) {
        ...
        if ( $page_id == $cgaDashSetting['setting']['cycleTablePage'] ) {
			$page_template = CGA_PLUGIN_BASEPATH . '/templates/cycle-table.php';
		}
        if ( $page_id == $cgaDashSetting['setting']['oppvizPage'] ) {
			$page_template = CGA_PLUGIN_BASEPATH . '/templates/custom-cga-oppviz-template.php';
		}
        if ( $page_id == $cgaDashSetting['setting']['networkGraph'] ) {
			$page_template = CGA_PLUGIN_BASEPATH . '/templates/custom-cga-network-graph-template.php';
		}
		return $page_template;
    }
